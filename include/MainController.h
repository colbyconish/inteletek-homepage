...
public:
    ...
    ADD_METHOD_TO(MainController::ServicesRoute, "/services", "InsecureFilter");
    ...
    void ServicesRoute(const HttpRequestPtr& req, std::function<void (const HttpResponsePtr &)> &&callback) const;
